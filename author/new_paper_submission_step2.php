            ...
            <div class="card-body">
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="mt-2">
                                    <label for=""><b>Select Document For Manuscript: <span
                                                class="text-danger">*</span></b></label>
                                    <div class="input-group mt-2">
                                        <br>
                                        <input type="file" class="form-control" name="manuscript_pdf" required
                                            accept="application/pdf" id="manuscript_pdf" onchange="uploadManuscript()">
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="mt-2">
                                    <label for=""><b>Select Document For Cover Letter: <span
                                                class="text-danger">*</span></b></label>
                                    <div class="input-group mt-2">
                                        <br>
                                        <input type="file" class="form-control" name="coverletter_pdf" required
                                            accept="application/pdf" id="coverletter_pdf"
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="mt-2">
                                    ...
                                    <div class="input-group mt-2">
                                        <br>
                                        <input type="file" class="form-control" name="supplimentary_file_pdf" required
                                            accept="application/pdf" id="supplimentary_file_pdf"
                                            onchange="uploadSupplimentaryFile()">
                                    </div>
                                </div>
                                ...
                                <p id="supplimentary_file_pdf_error"
                                    class="text-warning bg-black text-center m-2 fw-bold "></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-4 col-12">
                        <div class="mt-3">
                            <input type="submit" name="submit" class="form-control btn btn-success fw-bold"
                                value="Submit Paper">
                        </div>
                    </div>
                </div>
...
<?php
    ...
    if ($count_error > 0) {
        ...
        $insert_qry = "INSERT INTO `new_paper`(`author_id`, `paper_title`, `paper_abstract`, `paper_keywords`, `paper_type`, `authors_name`, `authors_affiliation`, `authors_designation`, `authors_email`, `manuscript_pdf`, `cover_letter_pdf`, `manuscript_image`, `supplimentary_file`, `paper_status`) VALUES ('$_SESSION[author_id]','$paper_title','$paper_abstract','$paper_keyword','$paper_type','$input_field_name','$input_field_affiliation','$input_field_designation','$input_field_email','$manuscript_pdf_file_name','$cover_letter_pdf_file_name','$manuscript_image_file_name','$supplimentary_pdf_file_name','1')";
        ...
        if ($run_insert_qry) {
            ...
            $mail->Body = '<h5>Dear Sir/Madam, <br />You have successfully submitted your new paper.Please check your paper status. <br /> <br /> Best Regards, JKKNIU Journal Organization</h5>';
            if ($mail->send()) {
                $mail->ClearAddresses();
                $mail->clearReplyTos();
