...
<body>
  ...
  <nav class="side-navbar">
    ...
    <ul class="list-unstyled">
      ...
      <li class="sidebar-item"><a class="sidebar-link fs-5" href="updated_paper.php"> <i
            class="fa-solid fa-file-circle-exclamation m-1"></i> Updated Paper </a></li>
        ...
        <div class="container-fluid">
          <div class="d-flex align-items-center justify-content-between w-100">
            ...
            <ul class="nav-menu mb-0 list-unstyled d-flex flex-md-row align-items-md-center">
              <!-- Log out-->
              <li class="nav-item"><a class="btn btn-danger p-1 a_hover" href="author_logout.php"> <span
