            ...
            <div class="table-responsive">
              <table class="table table-bordered table-hover text-center">
                ...
                <tbody>
                  ...
                  $select_from_new_paper = "SELECT * FROM `new_paper` WHERE `paper_status`=5";
                  ...
                  <tr>
                    ...
                    <td>
                      <button class="btn btn-success text-light fw-bold"><a
                          href="view_paper.php?id=<?php echo $row['id'] ?>" class="nav-link">View</a></button>
                      <button class="btn btn-danger text-light fw-bold"><a
                          href="review_paper.php?id=<?php echo $row['id'] ?>" class="nav-link">On
                          Review</a></button>
                    </td>
                  </tr>
                  <?php
