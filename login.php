        ...
        <div class="card text-white bg-light shadow mb-2">
          ...
          <div class="card-body">
            ...
            <div class="input-group mt-2 ">
              ...
              <select class="form-control" name="select_author_reviewer_editor" id="" required>
                ...
                <option <?php if (isset($_POST['select_author_reviewer_editor']) &&
                  $_POST['select_author_reviewer_editor']=="Author")
                  echo "selected"; ?>>Author</option>
                <option <?php if (isset($_POST['select_author_reviewer_editor']) &&
                  $_POST['select_author_reviewer_editor']=="Reviewer")
                  echo "selected"; ?>>Reviewer</option>
                <option <?php if (isset($_POST['select_author_reviewer_editor']) &&
                  $_POST['select_author_reviewer_editor']=="Main Editor")
                  echo "selected"; ?>>Main Editor</option>
                <option <?php if (isset($_POST['select_author_reviewer_editor']) &&
                  $_POST['select_author_reviewer_editor']=="Associative Editor")
                  echo "selected"; ?>>Associative Editor
                </option>
              </select>
            </div>
            ...
            <div class="form-group">
              ...
              <p class="text-center text-success form-control"
                style="font-family: 'Courgette', cursive;letter-spacing:15px;font-size:20pt;padding:10px;user-select: none;">
            ...
            <div class="input-group">
              <input type="text" class="form-control" name="captcha" placeholder="Please Enter The Above Captcha"
                required>
              <br>
            </div>
            ...
            <div class="mt-1 text-center">
              ...
              <p class="text-dark">Not registered yet? <a href="register.php"
                  class="text-decoration-none fw-bolder">Register now.</a> </p>
            </div>
          </div>
        </div>
      </form>
